...
export const Footer = () => {
  ...
  return (
    <footer className="bg-muted text-secondary pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Creating digital solutions that drive business growth and enhance user experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services" className="hover:text-primary">E-commerce Solutions</Link></li>
              <li><Link to="/services" className="hover:text-primary">Cloud Services</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Lovable Digital Agency. All rights reserved.
            </p>
